...
class CreateDepartamentoDuplicateIntegrationTest extends BaseIntegrationTest {

    @Test
    void shouldReturnConflictWhenCreatingDepartamentoWithDuplicatedNombre() throws Exception {
        DepartamentoCreateRequest request = new DepartamentoCreateRequest();
        request.setNombre("Marketing");
        request.setDescripcion("Area comercial");
