...
class DeleteEmpleadoConflictIntegrationTest extends BaseIntegrationTest {

    @Test
    void shouldReturnConflictWhenDeletingAlreadyInactiveEmpleado() throws Exception {
        EmpleadoCreateRequest request = new EmpleadoCreateRequest();
        request.setNombre("Juan Perez");
        request.setTelefono("5551234");
        request.setEmail("delete.conflict@ejercicio3.local");
